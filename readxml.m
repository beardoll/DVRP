...
function [routeSet] = extractRouteSetInfo(xmlDoc)
    ...
    for i = 0: routeNodeArray.getLength-1
...
function [value] = extractSingleValue(xmlDoc, nodeName)
    % 单节点的值
    node = xmlDoc.getElementsByTagName(nodeName).item(0);
